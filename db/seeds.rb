...
WineDeal.create(name: "seventh", customer_id: c7.id, winery_id: w1.id)
WineDeal.create(name: "eight", customer_id: c8.id, winery_id: w4.id)
WineDeal.create(name: "ninth", customer_id: c9.id, winery_id: w4.id)
WineDeal.create(name: "tenth", customer_id: c10.id, winery_id: w1.id)